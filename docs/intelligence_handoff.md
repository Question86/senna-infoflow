...
_Generated: 2026-09-12T10:21:02Z_
...
- Dynamics score: `24.9`
- Published: `2026-09-12T05:56:19+00:00` / age_days `0.18`
...
- Band: `strong` (raw `extreme`)
- Dynamics score: `24.9`
- Published: `2026-06-19T01:58:32+00:00` / age_days `85.35`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Security zuerst. Exposure prüfen, Patchstand sichern, dann erst über Narrative reden.
...
- Dynamics score: `18.0`
- Published: `2026-09-12T06:31:47.040+00:00` / age_days `0.16`
...
- Band: `watch` (raw `watch`)
- Dynamics score: `18.0`
- Published: `2026-09-12T05:24:42.040+00:00` / age_days `0.21`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake
...
- Band: `watch` (raw `watch`)
- Dynamics score: `17.0`
- Published: `2026-09-12T09:54:07.040+00:00` / age_days `0.02`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
...
- Band: `watch` (raw `watch`)
- Dynamics score: `17.0`
- Published: `2026-09-12T02:26:39.219+00:00` / age_days `0.33`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
...
- Band: `watch` (raw `watch`)
- Dynamics score: `17.0`
- Published: `2026-09-12T01:14:31.040+00:00` / age_days `0.38`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
...
- Band: `watch` (raw `watch`)
- Dynamics score: `14.0`
- Published: `2026-09-12T09:09:05.040+00:00` / age_days `0.05`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake
...
- Band: `watch` (raw `watch`)
- Dynamics score: `14.0`
- Published: `2026-09-12T00:55:38.040+00:00` / age_days `0.39`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake
