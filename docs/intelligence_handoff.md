...
_Generated: 2026-09-13T15:20:17Z_
...
- Dynamics score: `24.9`
- Published: `2026-06-19T01:58:32+00:00` / age_days `86.56`
...
- Dynamics score: `18.0`
- Published: `2026-09-13T08:51:07.040+00:00` / age_days `0.27`
...
- Band: `watch` (raw `watch`)
- Dynamics score: `12.0`
- Published: `2026-09-13T07:45:30.040+00:00` / age_days `0.32`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake
...
- Band: `watch` (raw `watch`)
- Dynamics score: `12.0`
- Published: `2026-09-13T07:36:40.040+00:00` / age_days `0.32`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake
...
- Dynamics score: `10.0`
- Published: `2026-09-12T08:17:26+00:00` / age_days `1.29`
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `7.0`
- Published: `2026-09-13T00:11:29+00:00` / age_days `0.63`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Interessant, aber Einzelquellen-AI darf nicht die Lage dominieren.
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `7.0`
- Published: `2026-09-13T05:57:48+00:00` / age_days `0.39`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Interessant, aber Einzelquellen-AI darf nicht die Lage dominieren.
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `5.0`
- Published: `2026-09-13T05:24:43+00:00` / age_days `0.41`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Beobachten, nicht aufblasen.
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `5.0`
- Published: `2026-09-13T05:23:07+00:00` / age_days `0.41`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Beobachten, nicht aufblasen.
- Warum: no strong comparative reason
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `4.0`
- Published: `2026-09-13T09:42:08+00:00` / age_days `0.23`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Interessant, aber Einzelquellen-AI darf nicht die Lage dominieren.
- Warum: single-source AI hype brake -8.0, single-source AI cap enforced after phrase recheck
