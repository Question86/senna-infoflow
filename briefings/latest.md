...
- Findings after quality gate: `2`
- Source errors: `7`
- Priority after gate: high `0`, medium `0`, observe `2`
- Failed sensor groups: `other`=5, `security`=1, `social`=1
...
_Generiert: 2026-06-19T02:26:09+00:00_

## Kurzlage

2 neue relevante Treffer. Stärkstes Signal: „SNP concedes Aberdeen South with Scottish Conservatives set to win“ aus GDELT Politics Unrest Elections RSS (Score 10, observation). 7 Quelle(n) hatten Abruffehler; Details stehen in latest.json.
...
- **SNP concedes Aberdeen South with Scottish Conservatives set to win** — Score 10, observation — [Quelle](https://www.theguardian.com/politics/2026/jun/19/snp-concedes-aberdeen-south-with-scottish-conservatives-set-to-win)
  - Quelle: GDELT Politics Unrest Elections RSS / `rss`
  - Zeit: published `2026-06-19T00:45:00+00:00`, fetched `2026-06-19T02:23:48+00:00`
  ...
  - Warum relevant: election (+2.0); unrest (+2.0); GDELT (+2.0); recent (+1.0); watchgraph modules elections_unrest (+3.0)
  - Kurz: SNP concedes Aberdeen South with Scottish Conservatives set to win
  - Handlung: Beobachten, Quelle sichern und bei Wiederholung erneut bewerten.
- **Cuba presenteert lijst maatregelen voor hervormen economie** — Score 10, observation — [Quelle](https://www.dagelijksestandaard.nl/nieuws/cuba-presenteert-lijst-maatregelen-voor-hervormen-economie)
  - Quelle: GDELT Politics Unrest Elections RSS / `rss`
  - Zeit: published `2026-06-19T00:45:00+00:00`, fetched `2026-06-19T02:23:48+00:00`
  - Treffer: election, GDELT, unrest, Watchgraph:elections_unrest
  - Watchgraph: elections_unrest
  - Markt-/Kontextkorb: LMT, RTX, NOC, GD, RHM.DE, BA, META, GOOGL, MSFT, RDDT, SNAP, PINS
  - Warum relevant: election (+2.0); unrest (+2.0); GDELT (+2.0); recent (+1.0); watchgraph modules elections_unrest (+3.0)
  - Kurz: Cuba presenteert lijst maatregelen voor hervormen economie
  - Handlung: Beobachten, Quelle sichern und bei Wiederholung erneut bewerten.
...
_Aktualisiert: 2026-06-19T02:26:10Z_
...
- **Südkorea Wahl-Infrastruktur und Protestvertrauen** — `south_korea_election_infrastructure_stress` / `active` / `routine`
  ...
  - Aktueller Feed-Signalabgleich: `2` Treffer
