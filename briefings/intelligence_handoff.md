...
_Generated: 2026-08-30T06:33:52Z_
...
- Dynamics score: `24.9`
- Published: `2026-06-19T01:58:32+00:00` / age_days `72.19`
...
- Dynamics score: `23.0`
- Published: `2026-08-29T23:47:17+00:00` / age_days `0.28`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Security zuerst. Exposure prüfen, Patchstand sichern, dann erst über Narrative reden.
...
- Dynamics score: `19.0`
- Published: `2026-08-29T10:20:11+00:00` / age_days `0.84`
...
- Band: `watch` (raw `watch`)
- Dynamics score: `14.0`
- Published: `2026-08-30T05:38:49.456+00:00` / age_days `0.04`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
...
- Band: `watch` (raw `watch`)
- Dynamics score: `12.0`
- Published: `2026-08-30T04:10:47.040+00:00` / age_days `0.1`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake
...
- Dynamics score: `11.0`
- Published: `2026-08-30T02:30:16+00:00` / age_days `0.17`
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `10.0`
- Published: `2026-08-30T03:47:24+00:00` / age_days `0.12`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Beobachten, nicht aufblasen.
- Warum: high terms: 10
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `10.0`
- Published: `2026-08-28T09:38:40+00:00` / age_days `1.87`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Beobachten, nicht aufblasen.
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `5.0`
- Published: `2026-08-30T01:28:17+00:00` / age_days `0.21`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Beobachten, nicht aufblasen.
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `5.0`
- Published: `2026-08-29T14:25:04+00:00` / age_days `0.67`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Beobachten, nicht aufblasen.
- Warum: no strong comparative reason
...
- Band: `quiet` (raw `quiet`)
- Dynamics score: `0`
- Published: `2026-06-20T02:49:51+00:00` / age_days `71.16`
- Vergleich: Die Dynamik wirkt aktuell wie Hintergrundrauschen.
- Senna: Beobachten, nicht aufblasen.
- Warum: momentum delta +1, aging penalty -16.0 for 71.2d old signal
