...
_Generated: 2026-07-18T23:03:10Z_
...
- Dynamics score: `28.0`
- Published: `2026-07-18T20:00:00+00:00` / age_days `0.13`
...
- Dynamics score: `24.9`
- Published: `2026-07-18T05:19:00.000+00:00` / age_days `0.74`
...
- Dynamics score: `24.9`
- Published: `2026-06-19T01:58:32+00:00` / age_days `29.88`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Security zuerst. Exposure prüfen, Patchstand sichern, dann erst über Narrative reden.
...
- Band: `strong` (raw `extreme`)
- Dynamics score: `24.9`
- Published: `2026-07-18T13:03:36+00:00` / age_days `0.42`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Security zuerst. Exposure prüfen, Patchstand sichern, dann erst über Narrative reden.
...
- Dynamics score: `23.0`
- Published: `2026-07-18T08:37:35.040+00:00` / age_days `0.6`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
...
- Band: `strong` (raw `strong`)
- Dynamics score: `23.0`
- Published: `2026-07-18T02:45:17.977+00:00` / age_days `0.85`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
...
- Band: `strong` (raw `strong`)
- Dynamics score: `21.0`
- Published: `2026-07-18T20:13:55.400+00:00` / age_days `0.12`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
...
- Band: `strong` (raw `strong`)
- Dynamics score: `21.0`
- Published: `2026-07-18T17:54:01.418+00:00` / age_days `0.21`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
...
- Band: `strong` (raw `strong`)
- Dynamics score: `21.0`
- Published: `2026-07-17T12:22:28+00:00` / age_days `1.44`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
...
- Band: `strong` (raw `strong`)
- Dynamics score: `21.0`
- Published: `2026-07-18T02:06:25+00:00` / age_days `0.87`
- Vergleich: Die Dynamik liegt über Normalniveau und verdient aktive Beobachtung.
- Senna: Interessant, aber Einzelquellen-AI darf nicht die Lage dominieren.
- Warum: AXI0M/User-Yps identity hit, identity recheck: no AXI0M/User-Yps phrase hit, single-source AI cap enforced after phrase recheck
...
- Dynamics score: `17.0`
- Published: `2026-07-18T16:26:12.040+00:00` / age_days `0.28`
...
- Band: `watch` (raw `watch`)
- Dynamics score: `17.0`
- Published: `2026-07-18T11:35:36.040+00:00` / age_days `0.48`
- Vergleich: Die Dynamik ist sichtbar, aber noch nicht stark genug für Alarm.
- Senna: Beobachten, nicht aufblasen.
- Warum: early terms: earthquake, high terms: 10
