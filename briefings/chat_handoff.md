...
_Generated: 2026-07-18T14:32:54+00:00_
...
### 1. WordPressの深刻度「緊急」脆弱性 wp2shell の概要と対応指針 - GMO Flatt Security Blog
- source: Hatena Bookmark Hotentry IT
- score: `19`
- published: `2026-07-18T13:03:36+00:00`
- url: https://blog.flatt.tech/entry/wp2shell_wordpress
- summary: 2026年7月17日、認証不要でリモートからの任意コード実行（RCE）につながる脆弱性「CVE-2026-63030」「CVE-2026-60137」を修正したWordPress 6.8.6、6.9.5、および 7.0.2 が公開されました（参考：WordPress 7.0.2 Release）。 弊社 GMO Flatt Security リサーチチームの検証では、脆弱なバージョンでは標準構成でも、管...

### 2. SQL MCP Server が GA したらしい
- source: Hatena Bookmark Hotentry IT
- score: `18`
- published: `2026-07-17T05:49:42+00:00`
- url: https://zenn.dev/microsoft/articles/1113250e1e63dc
- summary: 実際の使用では、Azure Container Apps にデプロイして使用する想定と思いますが、DAB コマンド ラインを使用してローカルで実行することもできます。ちょっと触ってみたいだけなので、今回はこのローカル実行で動きを確認しました。なので、RBAC の辺りなどは未確認です。 ツールの公開はコントロール可能 デフォルトで...

### 3. M 4.9 - 208 km SW of Bandar Lampung, Indonesia
- source: USGS M4.5+ Earthquakes Past Hour
- score: `15`
- published: `2026-07-18T08:37:35.040+00:00`
- url: https://earthquake.usgs.gov/earthquakes/eventpage/us7000t1kf
- summary: Time 2026-07-18 08:21:42 UTC 2026-07-18 08:21:42 UTC at epicenter Location 6.603°S 103.788°E Depth 23.73 km (14.75 mi)

### 4. M 5.3 - 119 km SW of Sarangani, Philippines
- source: USGS M4.5+ Earthquakes Past Hour
- score: `15`
- published: `2026-07-18T02:45:17.977+00:00`
