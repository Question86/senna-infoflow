...
_Generated: 2026-07-19T20:30:35+00:00_
...
- source: USGS M4.5+ Earthquakes Past Hour
- score: `13`
- published: `2026-07-19T18:06:41.606+00:00`
- url: https://earthquake.usgs.gov/earthquakes/eventpage/us7000t1tp
- summary: PAGER - GREEN ShakeMap - IV DYFI? - I Time 2026-07-19 17:45:16 UTC 2026-07-19 17:45:16 UTC at epicenter Location 14.159°N 92.905°W Depth 35.00 km (21.75 mi)

### 6. コーディングエージェントとGitを組み合わせる — Simon Willison のパターン集を読む
- source: Hatena Bookmark Hotentry IT
- score: `12`
- published: `2026-07-18T20:23:37+00:00`
- url: https://zenn.dev/seekseep/articles/git-with-coding-agents-patterns
- summary: この記事では、Simon Willison 氏のガイド Using Git with coding agents を日本語で要約し、コーディングエージェントとGitを組み合わせて使うための考え方を整理します。Claude Code のようなエージェントを普段の開発に使っていて、Gitまわりをもっと任せたいと感じている方を対象としています。 このガイドの主張 Si...

### 7. 役割ごとにFableとGPT-5.6を使い分けるAgent Teamの設計
- source: Hatena Bookmark Hotentry IT
- score: `12`
- published: `2026-07-16T13:13:50+00:00`
- url: https://zenn.dev/discus0434/articles/customizable-agent-teams
- summary: はじめに こんにちは。 ここ2週間ほどで、コーディングに使えるモデルが一気に増えました。 Anthropic からは Fable 5 が出て、GPT-5.6 は Sol、Terra、Luna の3段構えで登場し、しかもティアごとに reasoning effort の設定まで付いています。 どれを使えばいいのか、Fable と Sol はどちらが強いのか、という比較記事...
